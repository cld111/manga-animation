...
class PipelineConfig(BaseModel):
    ...
    # AnimateAnything generative animation engine (ADR 0024). These are the hyper-parameters
    # handed to the isolated worker for the model's native output (16 frames @ 8 fps = 2 s).
